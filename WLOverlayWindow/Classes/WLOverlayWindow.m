...
/**
 ...
 Used by WLOverlayWindow, overlay views are added to the overlay window container when
 @c activateOverlay is called and removed from the overlay window when @c deactivateOverlay is
 called.
 */
@interface WLOverlayWindowContainerView : UIView
@end

@interface WLOverlayWindow ()

@property(nonatomic, strong) NSMutableArray *overlays;
@property(nonatomic, strong) WLOverlayWindowContainerView *overlayView;
...
@implementation WLOverlayWindowContainerView

- (void)willRemoveSubview:(UIView *)subview {
  [super willRemoveSubview:subview];

  WLOverlayWindow *window = (WLOverlayWindow *)self.window;
...
@implementation WLOverlayWindow
...
- (void)commonInit {
  ...
  _overlayView = [[WLOverlayWindowContainerView alloc] initWithFrame:self.bounds];
...
- (UIWindowLevel)windowLevelForOverlay:(__unused UIView *)overlay {
  NSNumber *levelObject = objc_getAssociatedObject(overlay, &kLevelKey);
